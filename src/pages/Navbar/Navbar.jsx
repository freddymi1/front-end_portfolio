...
export default function NavBar({bg, action}) {
    ...
    // const getCurrentIcon = () => themeBtn.classList.contains(iconTheme) ? 'IoMoonOutline' : 'IoSunnyOutline';

    // if(selectedTheme){
    //     document.body.classList[selectedTheme === 'dark' ? 'add' : 'remove'](darkTheme)
    //     themeBtn.classList[selectedIcon === 'IoMoonOutline' ? 'add' : 'remove'](iconTheme)
    // }    
